...
Les clés de voôte étant les principes KISS & DRY.
...
## Ce qu'il faut éviter en CSS

* Les CSS > 2000 lignes
* Les sélecteurs interminables (Ex : #site .menu #foo #bar .active {...})
* Les !important
* Appliquer un style sur un id (#foo {...}) &mdash;

## Ce qu'il ne faut pas faire

* Ne pas mettre qu'une seul police dans 'font-family'
